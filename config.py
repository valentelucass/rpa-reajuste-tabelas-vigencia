...
def _aplicar_variaveis() -> None:
    ...
    global FASE2_VALIDACAO_MODO, FASE2_AMOSTRA_INICIAL
    global FASE2_JANELA_CONFIRMACAO, FASE2_AMOSTRAGEM_DISTRIBUIDA
    global FASE2_REVALIDAR_ANTES_DE_PROCESSAR
    ...
    FASE2_VALIDACAO_MODO = os.getenv("FASE2_VALIDACAO_MODO", "estrito").strip().lower() or "estrito"
    FASE2_AMOSTRA_INICIAL = int(os.getenv("FASE2_AMOSTRA_INICIAL", "5"))
    FASE2_JANELA_CONFIRMACAO = int(os.getenv("FASE2_JANELA_CONFIRMACAO", "20"))
    FASE2_AMOSTRAGEM_DISTRIBUIDA = os.getenv(
        "FASE2_AMOSTRAGEM_DISTRIBUIDA",
        "true",
    ).lower() in {"1", "true", "sim", "yes"}
    FASE2_REVALIDAR_ANTES_DE_PROCESSAR = os.getenv(
        "FASE2_REVALIDAR_ANTES_DE_PROCESSAR",
        "true",
    ).lower() in {"1", "true", "sim", "yes"}
...
FASE2_VALIDACAO_MODO: str = "estrito"
FASE2_AMOSTRA_INICIAL: int = 5
FASE2_JANELA_CONFIRMACAO: int = 20
FASE2_AMOSTRAGEM_DISTRIBUIDA: bool = True
FASE2_REVALIDAR_ANTES_DE_PROCESSAR: bool = True
